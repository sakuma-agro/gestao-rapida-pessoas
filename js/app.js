...
/* Acesso rápido na lateral da tela inicial: mora em js/atalhos.js desde
   24/09/2026 — cada login escolhe os seus (tabela app_preferencias). */
...
ligar('acesso rápido', () => ligarAtalhos(abrirModulo, mostrarAviso));
